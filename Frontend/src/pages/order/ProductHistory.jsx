    ...
    <>
      ...
      <div className="flex justify-center mt-20">
        <div className="shadow-xl p-10 sm:w-[70%] bg-white">
          ...
          <span style={getByStatusText(state.status)} className="text-2xl">
            {" "}
            {state.status}
          </span>
          ...
          text-[#666666]"
              ...
              <span className="">{state?.user?.phone}</span>
            </div>
            <CardComp
              style={{
                maxWidth: "488px",
            ...
            >
              <div>
                <h5 className="text-xl text-[400]  ml-7 mb-3 text-[#0A2429]">
                  ...
                  {state?.products?.length > 1 ? "Products" : "Product"}
                </h5>
                      ...
                      >
                        <div className="flex flex-row text-[#222222]">
                          ...
                          <div className="flex flex-col w-full">
                            ...
                            <div className="flex mx-3 justify-between flex-wrap w-full">
