        ...
        <div className="lg:pr-7 py-5">
          <div className="text-left flex items-center mb-5">
            <img
              ...
              src={ArrowLeft}
              alt="avatar"
              onClick={(_) => navigate(addresses.checkedOut ? "/" : -1)}
            />
            ...
            <div className="lg:w-[580px]  lg:order-0 order-1">
              {!addresses.current.address ? (
                <>
                  ...
                  <AddressBoxDiv className="lg:w-[580px] w-full h-10 mt-1 px-  bg-white shadow pl-0 rounded-lg flex justify-between items-center">
                    <div
                      htmlFor="search"
                  ...
                  >
                    <div className="flex ... items-center mb-5">
                      ...
                      <div>
                        ...
                        <p>
                          Your order #{addresses.order.orderId} has been placed.
                        </p>
                      </div>
                    </div>
                    <span>
                    ...
                    <span className="block mt-2">
                      Time placed:{" "}
                      {dayjs(addresses.order.dateCreated).format(
                        "MMM DD, YYYY"
                      )}{" "}
              ...
              <div className="fle items-center mt-1">
                <CardComp
                  style={{
                    width: "100%",
                    maxWidth: "580px",
                  ...
                  <div className="w-full">
                        ...
                        <div className="w-full">
                          ...
                          cart?.length === 0 ? (
                            <Button
                              ...
                              disabled={true}
                              btnClass={"pr-0"}
                              wrapperClass={"mt- lg:ml-5 ml-0 rounded-none"}
                            />
                          ) : (
                    ...
                    {addresses.checkedOut && (
                      <Button
                        ...
                        parentClass="w-full"
                        wrapperClass={
                          "mt-7 lg:ml-5 ml-0 rounded w-full lg:w-[89%]"
                        }
                      />
                    )}
                  </div>
